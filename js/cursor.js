var main = document.querySelector(".cursorEffect");
...
document
  ...
  .addEventListener("mousemove", function (dets) {
    ...
    document.querySelector("#elem1 img").style.top = dets.y - 330 + "px";
  });
...
document
  ...
  .addEventListener("mousemove", function (dets) {
    ...
    document.querySelector("#elem2 img").style.left = dets.x - 720 + "px";
...
document
  ...
  .addEventListener("mousemove", function (dets) {
    ...
    document.querySelector("#elem3 img").style.top = dets.y - 330 + "px";
  });
